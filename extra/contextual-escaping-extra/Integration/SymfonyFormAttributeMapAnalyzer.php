 ...
 * @experimental
 */
final class SymfonyFormAttributeMapAnalyzer implements AttributeMapAnalyzerInterface
{
    ...
    public function analyze(ForNode $node, ?string $blockName): ?AttributeMapAnalysis
    {
        ...
        return new AttributeMapAnalysis('Symfony Form trusted attribute map');
    }
}
