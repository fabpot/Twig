...
<style>
:root { color-scheme: light dark; --bg: #f5f7fb; --panel: #fff; --text: #172033; --muted: #667085; --border: #d9dfeb; --accent: #3769d4; --folder: #b7791f; --good: #087443; --good-bg: #e8f8ef; --bad: #b42318; --bad-bg: #fff0ee; --warn: #9a6700; --warn-bg: #fff8db; }
@media (prefers-color-scheme: dark) { :root { --bg: #11151d; --panel: #1a202c; --text: #edf1f7; --muted: #a6b0c3; --border: #374151; --accent: #8bb4ff; --folder: #f0bd66; --good: #6ce9a6; --good-bg: #123a2b; --bad: #ff9b94; --bad-bg: #421d1b; --warn: #ffd56a; --warn-bg: #3b3217; } }
